...
class CreateSampleData extends Seeder
{
    public function run()
    {
        ...
        $this->db->table('`Livro_Assunto`')->where('1=1')->delete();
        $this->db->table('`Livro_Autor`')->where('1=1')->delete();
        $this->db->table('`Livro`')->where('1=1')->delete();
        $this->db->table('`Assunto`')->where('1=1')->delete();
        $this->db->table('`Autor`')->where('1=1')->delete();
